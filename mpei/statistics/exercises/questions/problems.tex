...
\begin{enumerate}
      ...
      \item Постройте метод статистических испытаний для вычисления интеграла
            ...
            \begin{gather*}
                  ...
                  %
                  J
                  = (4 - 1) (e^2 - \sqrt{e}) \int \limits_{0}^{1} \frac{\ln (\sqrt{e} + (e^2 - \sqrt{e}) x)^2 - \sqrt{e}}{4 - 1} dx + \sqrt{e} (4 - 1).
            \end{gather*}
            Вычисляется
            \[
                  \widetilde{J}
                  = \int \limits_{0}^{1} \frac{\ln (\sqrt{e} + (e^2 - \sqrt{e}) x)^2 - \sqrt{e}}{4 - 1} dx
            ...
            \begin{multline*}
                  ...
                  = \left( \Phi^{-1} \left( \frac{1 + P_\delta}{2} \right) \right)^2 \frac{\overline{D}}{\left( \frac{\delta^2}{\left( e^2 - \sqrt{e} \right) (4 - 1)} \right)}
                  = \left( \Phi^{-1} ( 0.975 ) \right)^2 \frac{\frac{1}{4}}{\left( \frac{10^{-6}}{\left( e^2 - \sqrt{e} \right) 3} \right)} \approx \\
                  \approx 1.96^2 \frac{0.25}{\left( \frac{10^{-6}}{5.74 \cdot 3} \right)}
                  \approx 3.8416 \cdot 4.305 \cdot 10^6
                  \approx 16.538088 \cdot 10^6
                  = 16 538 088 .
            \end{multline*}
      ...
      \item Постройте метод статистических испытаний для вычисления интеграла
            ...
            \begin{multline*}
                  n
                  \ge \overline{n}_\delta
                  = \left( \Phi^{-1} \left( \frac{1 + P_\delta}{2} \right) \right)^2 \frac{\overline{D}}{\left( \frac{\delta^2}{\left( 1 - \frac{1}{\sqrt{2}} \right) (1-(-1))} \right)}
                  = \left( \Phi^{-1} ( 0.995 ) \right)^2 \frac{\frac{1}{4}}{\left( \frac{0.0001}{\left( 1 - \frac{1}{\sqrt{2}} \right) 2} \right)} \approx \\
                  \approx 2.5759^2 \frac{0.25}{\left( \frac{0.0001}{0.2929 \cdot 2} \right)}
                  \approx 6.6352 \cdot 0.14645 \cdot 10^4
                  \approx 0.9718 \cdot 10^4
                  = 9 718 .
            \end{multline*}
