...
\begin{document}
    ...
    \part{Введение}
    \include{introduction/complex}
    \include{introduction/wave}


    \part{Излучение сигналов}
    \include{emission/emitter}
    \include{emission/array}
    \include{emission/scheme}


    \part{Приём сигналов}
    \include{jammers/receivers}
    \include{jammers/search/problems}
    \include{jammers/search/theory}
    \include{jammers/search/methods}
    \include{jammers/adaptation/problems}
    \include{jammers/estimate}

    \part{Линейные системы}

    \include{appendix/dependence}
